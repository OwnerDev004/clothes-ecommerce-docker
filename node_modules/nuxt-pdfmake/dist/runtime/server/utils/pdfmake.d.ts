...
export declare function useServerPDFMake(): typeof import("pdfmake/build/pdfmake");
/**
 ...
 * ```
 */
export declare function createPDFBuffer(docDefinition: TDocumentDefinitions): Promise<Buffer>;
/**
 ...
 * ```
 */
export declare function createPDFBase64(docDefinition: TDocumentDefinitions): Promise<string>;
